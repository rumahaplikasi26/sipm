...
class ReportProgressIndex extends Component
{
    use LivewireAlert;
    ...
    {
        return view('livewire.report.progress.report-progress-index')->layout('layouts.app', ['title' => 'Report Activity Progress']);
    }
}
