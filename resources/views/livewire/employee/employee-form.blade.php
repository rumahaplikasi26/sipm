        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="submit" class="needs-validation" novalidate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('phone') is-invalid @enderror" id="formrow-phone-input"
                                wire:model="phone" placeholder="Enter Employee Phone">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control @error('group') is-invalid @enderror" wire:model="group" data-placeholder="Choose ...">
