<div class="card task-box" id="uptask-2">
    <div class="card-body">
        <div class="dropdown float-end">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="javascript:void(0);" class="dropdown-item edittask-details"
                    wire:click="$dispatch('show-canvas-dependency',{activity_id: {{ $activity->id }}})"><i
                        class="mdi mdi-bug"></i> Manage Dependency</a>
        ...
        <div class="float-end ms-2">
            <span class="badge  badge-soft-primary font-size-12" id="task-status">{{ $activity->progress }}
                %</span>
        </div>
        <div>
            <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark"
                    id="task-name">{{ $activity->title }}</a></h5>
