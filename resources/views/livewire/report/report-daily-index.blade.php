<div>
    @livewire('component.layout.breadcrumb', ['breadcrumbs' => [['name' => 'Report Activity Daily', 'url' => route('activity.report.daily')]]], key('breadcrumb'))
    ...
    @if (count($activities) > 0)
        @livewire('report.report-daily-preview', ['activities' => $activities], key('report-daily-preview' . time()))
    @endif
