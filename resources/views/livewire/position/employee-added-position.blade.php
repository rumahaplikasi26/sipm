        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title" id="insertEmployeePositionLabel">Add Employee To Position</h5>
                    ...
                    <form class="needs-validation" novalidate wire:submit.prevent="submitInsertMultiple">
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            <button type="button" class="btn  btn-secondary waves-effect"
                                wire:click="$dispatch('close-form-add-position')">Close</button>
    ...
    @push('js')
        <script>
            document.addEventListener('livewire:init', function() {
                Livewire.on('open-modal-add-position', () => {
                    $('#insertEmployeePosition').modal('show');
                });

                Livewire.on('close-modal-add-position', () => {
                    $('#insertEmployeePosition').modal('hide');
                });
            })
        </script>
    @endpush
