        ...
        <div class="p-2">
            <div class="d-flex">
                ...
                <div class="overflow-hidden me-auto">
                    ...
                    <p class="text-muted text-truncate mb-0">{{$category->inventories->count()}} Inventory</p>
                </div>

                <div class="avatar-xs align-self-center ms-2">
                    <div class="avatar-title bg-warning rounded font-size-16" wire:click="$dispatch('category-edit', { category: {{ $category }} })">
